...
public class ResaleDAO {
	  public List<Resale> getAllTickets() {
	        List<Resale> tickets = new ArrayList<>();
				...
				try (Connection conn = DBManager.getConnection();
	            	...
	            	while (rs.next()) {
	                        ...
	                        tickets.add( new Resale( ticketId, gameDate, startTime, homeTeamName, awayTeamName, stadiumName, seatPrice ,seatType, seatNumber, 0));
	                    }
				...
				try (
						...
						try (ResultSet resultSet = pstmt.executeQuery()) {
					        if (resultSet.next()) {
		                        ...
		                        game = new Resale( ticketId, gameDate, startTime, homeTeamName, awayTeamName, stadiumName, seatPrice ,seatType, seatNumber, 0);
		          		}
