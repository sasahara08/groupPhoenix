    ...
    public List<Ticket> getAllTickets() {
        ...
        try (Connection conn = DBManager.getConnection();
            ...
            while (rs.next()) {
				...
				tickets.add(new Ticket(gameId, gameDate, startTime, homeTeamName, awayTeamName, stadiumName, 0, null, 0, 0));
            }
		...
		public Ticket getGameIdById(int ticket1) {
			Ticket game = null;
			String sql = "SELECT g.game_id, game_date , g.start_time, ht.team_name AS home_team_name, at.team_name AS away_team_name, sd.stadium_name, st.seat_price "
			        + "FROM tickets t "
			        + "JOIN ticket_statuses ts ON t.ticket_status_id = ts.ticket_status_id "
				...
				try (ResultSet resultSet = pstmt.executeQuery()) {
			        if (resultSet.next()) {
			            ...
			            int seatPrice = resultSet.getInt("seat_price");
			             ...
			             game = new Ticket(gameId, gameDate, startTime, homeTeamName, awayTeamName, stadiumName, seatPrice, null, 0, 0);
				}
				}
