...
public class Resale {
	    ...
	    // Constructor
	    public Resale( int ticketId, Date gameDate, Time startTime, String homeTeamName, String awayTeamName, String stadiumName, int seatPrice, String seatType, String seatNumber, int ticketStatusId) {
