...
public class Ticket {
    ...
    // Constructor
    public Ticket(int gameId, Date gameDate, Time startTime, String homeTeamName, String awayTeamName, String stadiumName, int seatPrice, String seatType, int ticketId, int ticketStatus) {
