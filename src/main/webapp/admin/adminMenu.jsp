...
<body>
	...
	<div class="adminMenu">
		...
		<a href="${pageContext.request.contextPath}/AdminMember" class="button25">1.会員情報管理</a> 
		<a href="${pageContext.request.contextPath}/game" class="button25">2.試合情報管理</a>
		<a href="${pageContext.request.contextPath}/AdminTicket" class="button25">3.チケット情報管理</a>
		<a href="${pageContext.request.contextPath}/AdminSales" class="button25">4.売上管理</a> 
