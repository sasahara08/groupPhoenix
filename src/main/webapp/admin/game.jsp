...
<body>
	...
	<div class="searchForm">
		<form class="gameSearch" action="/groupPhoenix/game" method="post">
			...
			<div class="formItem">
				<label for="status">試合ステータス</label> すべて <input type="radio" id="all" name="status" value="all"> 今後開催 <input
					type="radio" name="status" value="all"> 終了 <input type="radio" name="status" value="all"> <input
					type="hidden" name="gamePage" value="search">
			</div>
							...
							<td>
								<div>
									<form action="/groupPhoenix/game" method="get" class="inline-form">
										<input type="hidden" name="editGameId" value="${game.gameId}"> <input type="hidden"
											name="editGameDate" value="${game.gameDate}"> <input type="hidden" name="editGameTime"
											value="${game.startTime}"> <input type="hidden" name="editHomeTeam" value="${game.homeTeamName}">
										<input type="hidden" name="editAwayTeam" value="${game.awayTeamName}"> <input type="hidden"
											name="editStadiumName" value="${game.stadium}"> <input type="hidden" name="gamePage" value="edit">
									...
									<form action="/groupPhoenix/game" method="get" class="inline-form">
										<input type="hidden" name="gameId" value="${game.gameId}"> <input type="hidden" name="gameDate"
											...
											value="${game.awayTeamName}"> <input type="hidden" name="stadiumName" value="${game.stadium}">
										<input type="hidden" name="gamePage" value="delete"> <input type="submit" value="削除" name="delete">
									</form>
								</div>
							</td>
						</tr>
