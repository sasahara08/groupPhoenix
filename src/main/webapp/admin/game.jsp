...
<!--		未ログイン時は「ログイン」、ログイン時は「ログアウト」-->
	...
	<div class="searchForm">
		<form class="gameSearch" action="/groupPhoenix/game" method="post">
			...
			<div class="formItem">
				<label for="gameId">試合ID</label>
				<input type="text" name="gameId">
			</div>

			<div class="formItem">
				<label for="gameDay">試合日</label>
				<input type="date" name="gameDay">
			</div>

			<div class="formItem">
				<label for="homeTeam">チーム(ホーム)</label> 
			...
			<div class="formItem">
				<label for="awayTeam">チーム(アウェイ)</label> 
			...
			<div class="formItem">
				<label for="status">試合ステータス</label> 
					すべて <input type="radio" id="all" name="status" value="all"> 
					今後開催 <input type="radio" name="status" value="all"> 
					終了 <input type="radio" name="status" value="all"> 
